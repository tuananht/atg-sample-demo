...
'step 5: At Page_releases click on hyperlink_team_project_requirements --> navigate to Page_requirements'
...
'step 6: At Page_requirements click on hyperlink_team_project_test_reports_test_design_r --> navigate to Page_test-reports_test-design_requirement-test-run-coverage'
...
'step 7: At Page_test-reports_test-design_requirement-test-run-coverage click on hyperlink_team_project_overview --> navigate to Page_overview'

testObj = findTestObject('Object Repository/Page_team_project_test-reports_test-design_requirement-test-run-/hyperlink_object_1')
...
'step 9: At Page_overview click on hyperlink_team_project_failed_test_result --> navigate to Page_failed-test-result'
