...
'step 6: At Page_admin_users click on hyperlink_object'

testObj = findTestObject('Object Repository/Page_admin_users/hyperlink_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/admin/users(?:#.*)?(?:\\?.*)?$', true)
