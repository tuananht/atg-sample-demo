...
'step 6: At Page_test-reports_test-design_requirement-test-run-coverage click on button_select_organization'

testObj = findTestObject('Object Repository/Page_team_project_test-reports_test-design_requirement-test-run-coverage/button_object_1')
