...
'step 6: At Page_test-planning input on input_name'

testObj = findTestObject('Object Repository/Page_team_project_test-project/input_name_1')
...
WebUI.setText(testObj, var_1_input_name_1)

'step 7: At Page_test-planning click on button_object'

testObj = findTestObject('Object Repository/Page_team_project_test-project/button_object_10')
...
'step 8: At Page_test-planning click on hyperlink_ --> navigate to Page_test-planning#'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_37')
...
'step 9: At Page_test-planning# click on input_radio_buttons'

testObj = findTestObject('Object Repository/Page_team_project_test-planning/input_object_47')
