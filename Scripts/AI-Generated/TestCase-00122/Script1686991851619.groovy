...
'step 6: At Page_grid input on input_search_input'

testObj = findTestObject('Object Repository/Page_team_project_grid/input_object_12')
...
WebUI.setText(testObj, var_1_input_object_12)

'step 7: At Page_grid click on hyperlink_menu_reports --> navigate to Page_overview'
...
'step 9: At Page_katalon-eyes click on hyperlink_test_project --> navigate to Page_test-project'
...
'step 10: At Page_test-project click on hyperlink_test_environment_installation --> navigate to Page_test-environment-installation'
...
'step 11: At Page_test-environment-installation click on hyperlink_agent --> navigate to Page_agent'
...
'step 12: Add visual checkpoint at Page_agent'
