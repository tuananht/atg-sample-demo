...
'step 15: At Page_test-project click on hyperlink_test_project'
...
'step 16: At Page_test-project click on hyperlink_agent --> navigate to Page_agent'
...
'step 17: At Page_agent click on hyperlink_test_project --> navigate to Page_test-project'
...
'step 18: At Page_test-project click on button_recent_work'
...
'step 19: At Page_test-project click on div_object'

testObj = findTestObject('Object Repository/Page_team_project_test-project/div_object_1')
...
'step 20: At Page_test-project click on hyperlink_custom_fields --> navigate to Page_custom-fields'
...
'step 21: Add visual checkpoint at Page_custom-fields'
