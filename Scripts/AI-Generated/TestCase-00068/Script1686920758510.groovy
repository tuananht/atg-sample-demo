...
'step 15: At Page_katalon-eyes click on td_object'

testObj = findTestObject('Object Repository/Page_team_project_katalon-eyes/td_object_1')
...
'step 16: At Page_katalon-eyes click on td_object'

testObj = findTestObject('Object Repository/Page_team_project_katalon-eyes/td_object_2')
...
'step 17: At Page_katalon-eyes click on td_object'

testObj = findTestObject('Object Repository/Page_team_project_katalon-eyes/td_object_3')
...
'step 18: At Page_katalon-eyes click on hyperlink_page_visual_testing_click_baseline_versi --> navigate to Page_baseline-version'
...
'step 19: At Page_baseline-version click on div_object'

testObj = findTestObject('Object Repository/Page_team_project_baseline-collection_version/div_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/baseline-collection/.*/version(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 20: Add visual checkpoint at Page_baseline-version'
