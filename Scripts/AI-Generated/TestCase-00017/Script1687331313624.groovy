...
'step 3: At Page_t_how-to-add-days-years-to-current-date-using-java-time-localdatetime click on div_object'

testObj = findTestObject('Object Repository/Page_t_how-to-add-days-years-to-current-date-using-java-time-localdatetime/div_object_1')
