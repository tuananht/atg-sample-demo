...
'step 2: Login at https://testops.staging.katalon.com/login --> navigate to Page_teams_projects'
...
'step 3: At Page_teams_projects click on button_object --> navigate to Page_home'
...
testObj = findTestObject('Object Repository/Page_organization_home/hyperlink_object_40')
...
testObj = findTestObject('Object Repository/Page_welcome/div_object_38')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/welcome(?:#.*)?(?:\\?.*)?$', true)
