...
'step 7: At Page_job click on hyperlink_team_project_grid_plan_job_session --> navigate to Page_job_session'

testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job/hyperlink_object_41')
...
'step 8: At Page_job_session click on hyperlink_team_project_test_design_test_cases --> navigate to Page_test-design_test-cases'

testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job_session/hyperlink_object_6')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/grid/plan/.*/job/session(?:#.*)?(?:\\?.*)?$', true)
