...
testObj = findTestObject('Object Repository/Page_organization_teams_projects/button_object_2')
...
testObj = findTestObject('Object Repository/Page_organization_teams_projects/hyperlink_object_2')
...
'step 6: At Page_admin_license_keys_per_user_kse click on button_object'

testObj = findTestObject('Object Repository/Page_organization_admin_license_keys_kse/button_object')
...
'step 7: At Page_admin_license_keys_per_user_kse click on hyperlink_license_management'

testObj = findTestObject('Object Repository/Page_organization_admin_license_keys_kse/hyperlink_object_1')
...
'step 8: At Page_admin_license_keys_per_user_kse click on hyperlink_admin_settings --> navigate to Page_admin_settings'

testObj = findTestObject('Object Repository/Page_organization_admin_license_keys_kse/hyperlink_object_2')
...
'step 9: At Page_admin_settings click on button_select_organization'

testObj = findTestObject('Object Repository/Page_organization_admin_settings/button_object_2')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/organization/.*/admin/settings(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 10: Add visual checkpoint at Page_admin_settings'
