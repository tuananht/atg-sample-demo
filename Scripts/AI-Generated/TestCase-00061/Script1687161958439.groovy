...
testObj = findTestObject('Object Repository/Page_team_project_test-project/button_object_30')
...
testObj = findTestObject('Object Repository/Page_team_project_test-project/input_object_4')
...
'step 10: At Page_agent click on hyperlink_agent_k8s --> navigate to Page_agent_k8s'
...
'step 11: Add visual checkpoint at Page_agent_k8s'
