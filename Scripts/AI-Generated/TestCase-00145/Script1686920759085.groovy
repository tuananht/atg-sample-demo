...
'step 15: At Page_test-planning click on hyperlink_menu_visual_testing --> navigate to Page_katalon-eyes'
...
'step 18: At Page_agent click on hyperlink_agent_test_cloud --> navigate to Page_agent_test-cloud'
...
'step 19: At Page_agent_test-cloud click on hyperlink_test_environment_installation --> navigate to Page_test-environment-installation'

testObj = findTestObject('Object Repository/Page_team_project_agent_test-cloud/hyperlink_object_1')
...
'step 20: Add visual checkpoint at Page_test-environment-installation'
