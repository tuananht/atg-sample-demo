...
'step 6: At Page_grid click on hyperlink_team_project_agent_k8s --> navigate to Page_agent_k8s'

testObj = findTestObject('Object Repository/Page_team_project_grid/hyperlink_object_38')
...
'step 7: Add visual checkpoint at Page_agent_k8s'
