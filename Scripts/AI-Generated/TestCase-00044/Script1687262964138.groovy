...
'step 5: At Page_test-result-verifycustomsortonsearchresults click on hyperlink_test_result_verifycustomsortonsearchresu --> navigate to Page_test-result-verifycustomsortonsearchresults_re-runs'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-result/hyperlink_object_23')
...
'step 6: Add visual checkpoint at Page_test-result-verifycustomsortonsearchresults_re-runs'
