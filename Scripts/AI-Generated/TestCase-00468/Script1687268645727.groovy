...
'step 2: Add visual checkpoint at Page_t_how-to-change-the-default-browser-in-katalon-studio'

WebUI.takeFullPageScreenshotAsCheckpoint('TestCase-00468_visual_checkpoint')
