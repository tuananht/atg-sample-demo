...
'step 6: At Page_grid click on hyperlink_team_project --> navigate to Page_project'

testObj = findTestObject('Object Repository/Page_team_project_grid/hyperlink_object_8')
...
'step 7: At Page_project click on hyperlink_team_project_releases --> navigate to Page_releases'
...
'step 8: At Page_releases click on hyperlink_team_project_requirements --> navigate to Page_requirements'
...
testObj = findTestObject('Object Repository/Page_team_project_requirements/div_object_6')
...
testObj = findTestObject('Object Repository/Page_team_project_requirements/th_object_1')
...
testObj = findTestObject('Object Repository/Page_team_project_requirements/input_object')
...
'step 12: At Page_requirements click on hyperlink_team_project_test_reports_test_design_r --> navigate to Page_test-reports_test-design_requirement-test-run-coverage'

testObj = findTestObject('Object Repository/Page_team_project_requirements/hyperlink_object_4')
...
'step 13: Add visual checkpoint at Page_test-reports_test-design_requirement-test-run-coverage'
