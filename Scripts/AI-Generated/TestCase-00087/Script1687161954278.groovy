...
testObj = findTestObject('Object Repository/Page_organization_teams_projects/button_object_12')
...
testObj = findTestObject('Object Repository/Page_organization_teams_projects/hyperlink_object_16')
...
testObj = findTestObject('Object Repository/Page_team_project_settings/hyperlink_object_4')
...
testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_22')
...
'step 8: At Page_releases click on hyperlink_test_design_test_cases --> navigate to Page_test-design_test-cases'
...
'step 9: At Page_test-design_test-cases click on hyperlink_test_planning --> navigate to Page_test-planning'
...
'step 11: At Page_overview click on hyperlink_executions --> navigate to Page_executions'
...
'step 12: Add visual checkpoint at Page_executions'
