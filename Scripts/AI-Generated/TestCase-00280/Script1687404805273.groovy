...
'step 7: At Page_test-design_test-objects click on hyperlink_test_project --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-objects/hyperlink_object_6')
...
'step 12: Add visual checkpoint at Page_integrations'

WebUI.takeFullPageScreenshotAsCheckpoint('TestCase-00280_visual_checkpoint')
