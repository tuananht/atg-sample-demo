...
'step 15: At Page_test-runs input on input_search_input'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-runs/input_object')
...
'step 16: At Page_test-runs click on hyperlink_show_details_sidebar'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-runs/hyperlink_object_4')
...
'step 17: At Page_test-runs click on hyperlink_click_test_result_details --> navigate to Page_test-result-demo-login-testops'
...
'step 18: Add visual checkpoint at Page_test-result-demo-login-testops'
