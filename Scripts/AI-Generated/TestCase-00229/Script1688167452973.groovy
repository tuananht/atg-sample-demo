...
testObj = findTestObject('Object Repository/Page_team_project_executions/hyperlink_object_13')
...
'step 9: At Page_job click on hyperlink_team_project_test_project --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job/hyperlink_object_25')
...
'step 10: At Page_test-project click on hyperlink_team_project_test_project'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_75')
...
testObj = findTestObject('Object Repository/Page_team_project_test-project/div_object_90')
...
'step 12: At Page_test-project click on p_repository'

testObj = findTestObject('Object Repository/Page_team_project_test-project/p_object_1')
...
'step 13: At Page_test-project click on p_repository'
...
'step 14: At Page_test-project click on hyperlink_team_project --> navigate to Page_project'

testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_19')
...
'step 15: Add visual checkpoint at Page_project'
