...
'step 14: At Page_project click on hyperlink_test_design_test_cases --> navigate to Page_test-design_test-cases'
...
'step 15: At Page_test-design_test-cases click on div_root_uploaded_data'
...
'step 16: At Page_test-design_test-cases click on div_1354548'
...
'step 17: At Page_test-design_test-cases click on hyperlink_test_case_detail --> navigate to Page_test-design_test-cases-error'
...
'step 18: At Page_test-design_test-cases-error click on hyperlink_click_test_result_details --> navigate to Page_test-result-error'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-cases/hyperlink_object_6')
...
'step 19: At Page_test-result-error click on hyperlink_test_result_error_requests --> navigate to Page_test-result-error_requests'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-result/hyperlink_object')
...
'step 20: At Page_test-result-error_requests click on hyperlink_test_result_error_test_objects --> navigate to Page_test-result-error_test-objects'
...
'step 21: At Page_test-result-error_test-objects click on hyperlink_test_result_error_similar_failures --> navigate to Page_test-result-error_similar-failures'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-result_test-objects/hyperlink_object')
...
'step 22: At Page_test-result-error_similar-failures click on hyperlink_test_result_error_comments --> navigate to Page_test-result-error_comments'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-result_similar-failures/hyperlink_object')
...
'step 23: At Page_test-result-error_comments click on hyperlink_test_result_error_re_runs --> navigate to Page_test-result-error_re-runs'
...
'step 24: Add visual checkpoint at Page_test-result-error_re-runs'
