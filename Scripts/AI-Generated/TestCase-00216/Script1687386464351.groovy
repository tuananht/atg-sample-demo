...
testObj = findTestObject('Object Repository/Page_team_project_git-test-project_setup/div_object_35')
...
testObj = findTestObject('Object Repository/Page_team_project_test-project/button_object_6')
...
testObj = findTestObject('Object Repository/Page_team_project_test-project/hyperlink_object_27')
...
'step 11: At Page_test-project click on hyperlink_releases --> navigate to Page_releases'
...
'step 12: At Page_releases click on hyperlink_requirements --> navigate to Page_requirements'
...
'step 13: Add visual checkpoint at Page_requirements'

WebUI.takeFullPageScreenshotAsCheckpoint('TestCase-00216_visual_checkpoint')
