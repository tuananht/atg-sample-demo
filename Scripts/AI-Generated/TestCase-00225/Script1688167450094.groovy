...
'step 6: At Page_test-design_test-cases click on hyperlink_team_project_test_design_test_suites --> navigate to Page_test-design_test-suites'
...
'step 7: At Page_test-design_test-suites click on hyperlink_team_project_test_design_test_objects --> navigate to Page_test-design_test-objects'
...
'step 8: At Page_test-design_test-objects click on hyperlink_team_project_test_project --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_test-design_test-objects/hyperlink_object_4')
...
'step 9: At Page_test-project click on hyperlink_team_project_agent --> navigate to Page_agent'
...
'step 10: At Page_agent click on hyperlink_team_project_test_environment_installat --> navigate to Page_test-environment-installation'

testObj = findTestObject('Object Repository/Page_team_project_agent/hyperlink_object_2')
...
'step 11: At Page_test-environment-installation click on button_object'
...
'step 12: At Page_test-environment-installation click on hyperlink_team_project_integrations --> navigate to Page_integrations'
