...
'step 15: At Page_test-runs click on hyperlink_click_test_result_details --> navigate to Page_test-result-demo-login-testops'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-runs/hyperlink_object_3')
...
'step 16: At Page_test-result-demo-login-testops click on hyperlink_test_result_demo_login_testops_requests --> navigate to Page_test-result-demo-login-testops_requests'
...
'step 17: At Page_test-result-demo-login-testops_requests click on hyperlink_test_result_demo_login_testops_test_obje --> navigate to Page_test-result-error_test-objects'
...
'step 18: Add visual checkpoint at Page_test-result-error_test-objects'
