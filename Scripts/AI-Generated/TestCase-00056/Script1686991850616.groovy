...
'step 4: At Page_executions click on hyperlink_testops_config --> navigate to Page_job'
...
'step 5: At Page_job click on button_object'

testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job/button_object_23')
...
'step 6: At Page_job click on hyperlink_'

testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job/hyperlink_object_11')
...
'step 7: At Page_job click on hyperlink_job_summary --> navigate to Page_job_summary'
...
'step 8: At Page_job_summary click on button_edit_schedule_dialog'

testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job_summary/button_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/grid/plan/.*/job/summary(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 9: Add visual checkpoint at Page_job_summary'
