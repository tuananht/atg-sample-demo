...
'step 7: At Page_admin_license_keys_unlimited_engine click on hyperlink_admin_license_keys_unlimited_engine_crea --> navigate to Page_admin_license_keys_unlimited_engine_create'

testObj = findTestObject('Object Repository/Page_organization_admin_license_keys_engine/hyperlink_object_22')
...
'step 8: At Page_admin_license_keys_unlimited_engine_create input on input_machine_id'

testObj = findTestObject('Object Repository/Page_organization_admin_license_keys_unlimited_engine_create/input_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/organization/.*/admin/license_keys/unlimited_engine/create(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(testObj, var_1_input_object)

'step 9: At Page_admin_license_keys_unlimited_engine_create click on button_object'

testObj = findTestObject('Object Repository/Page_organization_admin_license_keys_unlimited_engine_create/button_object_2')
...
'step 10: Add visual checkpoint at Page_admin_license_keys_unlimited_engine_create'
