...
'step 8: At Page_agent_k8s_create click on button_object'

testObj = findTestObject('Object Repository/Page_team_project_agent_create/button_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/agent/.*/create(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 9: Add visual checkpoint at Page_agent_k8s_create'
