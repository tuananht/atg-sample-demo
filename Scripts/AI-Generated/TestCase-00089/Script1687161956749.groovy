...
'step 6: At Page_executions click on hyperlink_test_planning --> navigate to Page_test-planning'
...
'step 7: At Page_test-planning click on hyperlink_releases --> navigate to Page_releases'
...
'step 8: At Page_releases click on hyperlink_project --> navigate to Page_project'

testObj = findTestObject('Object Repository/Page_team_project_releases/hyperlink_object_21')
...
'step 9: At Page_project click on hyperlink_menu_reports --> navigate to Page_overview'
...
'step 10: At Page_overview click on hyperlink_test_project --> navigate to Page_test-project'
...
'step 13: At Page_test-environment-installation click on hyperlink_integrations --> navigate to Page_integrations'
...
'step 14: At Page_integrations click on hyperlink_custom_fields --> navigate to Page_custom-fields'

testObj = findTestObject('Object Repository/Page_team_project_integrations/hyperlink_object_4')
...
'step 15: Add visual checkpoint at Page_custom-fields'
