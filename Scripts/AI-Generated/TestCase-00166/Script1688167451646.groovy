...
'step 6: At Page_overview click on hyperlink_team_project_test_reports_test_design_r --> navigate to Page_test-reports_test-design_requirement-test-run-coverage'
...
'step 7: At Page_test-reports_test-design_requirement-test-run-coverage click on hyperlink_team_project_test_project --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_test-reports_test-design_requirement-test-run-/hyperlink_object_4')
...
'step 8: At Page_test-project click on hyperlink_team_project_integrations --> navigate to Page_integrations'
