...
'step 17: At Page_job click on div_object'

testObj = findTestObject('Object Repository/Page_team_project_grid_plan_job/div_object')
...
'step 18: At Page_job click on div_object'
...
'step 19: At Page_job click on hyperlink_click_test_run_details --> navigate to Page_executions'
...
'step 20: At Page_executions click on hyperlink_test_project --> navigate to Page_test-project'

testObj = findTestObject('Object Repository/Page_team_project_executions/hyperlink_object_7')
...
'step 21: At Page_test-project click on hyperlink_test_environment_installation --> navigate to Page_test-environment-installation'
...
'step 22: At Page_test-environment-installation click on hyperlink_agent --> navigate to Page_agent'
...
'step 23: At Page_agent click on hyperlink_agent_local --> navigate to Page_agent_local'
...
'step 24: Add visual checkpoint at Page_agent_local'
