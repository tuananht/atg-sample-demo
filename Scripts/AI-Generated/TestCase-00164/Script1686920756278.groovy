...
'step 14: At Page_executions click on hyperlink_files --> navigate to Page_files'
...
'step 15: At Page_files click on hyperlink_defect --> navigate to Page_defect'
...
'step 16: At Page_defect click on hyperlink_test_reports_test_maintenance_active --> navigate to Page_test-reports_test-maintenance_active'

testObj = findTestObject('Object Repository/Page_team_project_executions_defect/hyperlink_object')
...
WS.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain +'/team/.*/project/.*/executions/.*/defect(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 17: At Page_test-reports_test-maintenance_active click on hyperlink_test_reports_test_design_requirement_tes --> navigate to Page_test-reports_test-design_requirement-test-run-coverage'
...
'step 18: At Page_test-reports_test-design_requirement-test-run-coverage click on hyperlink_overview --> navigate to Page_overview'
...
'step 19: At Page_overview click on hyperlink_test_planning --> navigate to Page_test-planning'
...
'step 20: At Page_test-planning click on hyperlink_grid --> navigate to Page_grid'
...
'step 21: Add visual checkpoint at Page_grid'
