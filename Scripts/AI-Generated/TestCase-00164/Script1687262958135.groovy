...
'step 7: At Page_test-reports_test-maintenance_active click on hyperlink_test_reports_test_design_requirement_tes --> navigate to Page_test-reports_test-design_requirement-test-run-coverage'
