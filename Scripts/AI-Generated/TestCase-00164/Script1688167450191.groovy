...
'step 6: At Page_test-planning click on hyperlink_click_test_result_details --> navigate to Page_test-result-verify-user-cannot-login'

testObj = findTestObject('Object Repository/Page_team_project_test-planning/hyperlink_object_39')
...
'step 7: At Page_test-result-verify-user-cannot-login click on hyperlink_menu_visual_testing --> navigate to Page_katalon-eyes'

testObj = findTestObject('Object Repository/Page_team_project_executions_test-result/hyperlink_object_20')
...
'step 8: At Page_katalon-eyes click on hyperlink_click_visual_test_result_details'
